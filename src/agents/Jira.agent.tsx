    ...
    <div className="page">
      <main className="content">
          ...
          <div className="agent-header">
            ...
            <div className="agent-info">
              ...
              <p className="agent-desc">
                A fully integrated Model Context Protocol (MCP) server and
                client for Jira Cloud, enhanced by AgentDNA for end-to-end trust
        ...
        <section className="section-card">
          ...
          <div className="two-col">
            <div className="usage-section">
              ...
              <p>
                Provides comprehensive Jira tool integration with AgentDNA
                signing:
              </p>
              <ul>
                <li>
                  Receives signed{" "}
                  <code className="code-inline">dna_envelope</code> from host
                </li>
          ...
          <div className="table-container">
            <table className="agent-table">
              ...
              <tbody>
                <tr>
                  <td>
                    <code className="code-inline">search_issues</code>
                  </td>
                  <td>JQL search via Jira v3 /search/jql endpoint</td>
                </tr>
                <tr>
                  <td>
                    <code className="code-inline">get_issue</code>
                  </td>
                  <td>Retrieve detailed issue information</td>
                </tr>
                <tr>
                  <td>
                    <code className="code-inline">create_issue</code>
                  </td>
                  <td>Create a new issue with ADF description support</td>
                </tr>
                <tr>
                  <td>
                    <code className="code-inline">add_comment</code>
                  </td>
                  <td>Add comments to existing issues</td>
                </tr>
                <tr>
                  <td>
                    <code className="code-inline">transition_issue</code>
                  </td>
        ...
        <section className="section-card highlight">
          ...
          <p className="hero-sub" style={{ marginBottom: "20px" }}>
            Launch the Streamlit UI with a single command. The MCP server is
            automatically started per request via Python stdio.
          </p>
          <div className="code-block">
        ...
        <section className="section-card">
          ...
          <div className="usage-section">
            <p>
              Ask your AI assistant to perform common Jira operations using
              natural language:
            </p>
            ...
            <p>
              <span className="code-inline">
                "Create a new task in KAN. Summary: Add login button.
        ...
        <div className="cta-container">
          <a
            href="https://github.com/rubixchain/agentdna/tree/main/examples/JIRA"
            className="cta"
          >
            View on GitHub
          </a>
